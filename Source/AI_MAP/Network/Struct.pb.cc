...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::PosInfo, _impl_.aimyaw_),
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.x_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.y_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.z_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.yaw_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.pitch_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.roll_),
  PROTOBUF_FIELD_OFFSET(::Protocol::ProjectileInfo, _impl_.bfight_),
};
...
uint8_t* PosInfo::_InternalSerialize(
  ...
  if (raw_aimyaw != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(9, this->_internal_aimyaw(), target);
  }
...
ProjectileInfo::ProjectileInfo(const ProjectileInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.pitch_){}
    , decltype(_impl_.roll_){}
    , decltype(_impl_.bfight_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.object_id_, &from._impl_.object_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.bfight_) -
    reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.bfight_));
...
// @@protoc_insertion_point(message_clear_start:Protocol.ProjectileInfo)
  ...
  ::memset(&_impl_.object_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.bfight_) -
      reinterpret_cast<char*>(&_impl_.object_id_)) + sizeof(_impl_.bfight_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          _impl_.bfight_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ProjectileInfo::_InternalSerialize(
  ...
  // bool bFight = 8;
  if (this->_internal_bfight() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(8, this->_internal_bfight(), target);
  }
...
void ProjectileInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_bfight() != 0) {
    _this->_internal_set_bfight(from._internal_bfight());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void ProjectileInfo::InternalSwap(ProjectileInfo* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProjectileInfo, _impl_.bfight_)
      + sizeof(ProjectileInfo::_impl_.bfight_)
      - PROTOBUF_FIELD_OFFSET(ProjectileInfo, _impl_.object_id_)>(
          reinterpret_cast<char*>(&_impl_.object_id_),
          reinterpret_cast<char*>(&other->_impl_.object_id_));
}
